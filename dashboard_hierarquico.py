...
"""
            ...
            for servidor in regional_data["servidores"]:
                ...
                tipo_icon = "[CONFIG]" if servidor["tipo"] == "idrac" else ""
...
"""
    ...
    def gerar_todos_dashboards(self):
        ...
        print("[START] Gerando dashboards hierárquicos...")
        ...
        print(f"[OK] Dashboard principal: {arquivo_principal}")
        ...
        for codigo_regional in dados["regionais"].keys():
            ...
            if html_regional:
                ...
                print(f"[OK] Dashboard regional: {arquivo_regional}")
        ...
        print(f"[OK] Dados salvos: {arquivo_dados}")
    ...
    def abrir_dashboard(self):
        ...
        print(f"\n[WEB] Abrindo dashboard: {arquivo_principal}")
